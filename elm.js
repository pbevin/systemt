...
Elm.Main.make = function (_elm) {
   ...
   name) {
      ...
      _L.fromArray([labelStyle]),
      _L.fromArray([A2($Html.input,
                   _L.fromArray([$Html$Attributes.type$("checkbox")
                                ,$Html$Attributes.checked(state)
                                ,A3($Html$Events.on,
                                "change",
                                $Html$Events.targetChecked,
                                function ($) {
                                   return $Signal.message(address)(tag($));
                                })]),
                   _L.fromArray([]))
                   ,$Html.text(name)]));
   });
   ...
   "u",
   "v",
   $SysT.S($SysT.S($SysT.Var("v"))),
   $SysT.Var("x")));
   var programs = _L.fromArray([{ctor: "_Tuple2"
                                ,_0: "double 2"
                                ,_1: $SysT.Ap($double)($SysT.num(2))}
                               ,{ctor: "_Tuple2"
                                ,_0: "double 4"
                                ,_1: $SysT.Ap($double)($SysT.num(4))}
                               ,{ctor: "_Tuple2"
                                ,_0: "plus 2 3"
                                ,_1: A2($SysT.Ap,
                                A2($SysT.Ap,plus,$SysT.num(2)),
                                $SysT.num(3))}
                               ,{ctor: "_Tuple2"
                                ,_0: "plus 5 6"
                                ,_1: A2($SysT.Ap,
                                A2($SysT.Ap,plus,$SysT.num(5)),
                                $SysT.num(6))}
                               ,{ctor: "_Tuple2"
                                ,_0: "triangle 3"
                                ,_1: $SysT.Ap(triangle)($SysT.num(3))}
                               ,{ctor: "_Tuple2"
                                ,_0: "triangle 6"
   ...
   model) {
      return function () {
         var show = $SysT.showE(model.numeric);
         var trace = $String.join("\n")($List.reverse(A2($List.map,
         show,
         model.trace)));
         return A2($Html.div,
         _L.fromArray([]),
         _L.fromArray([A2($Html.output,
                      _L.fromArray([outputStyle]),
...
Elm.SysT.make = function (_elm) {
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var showE = F2(function (numeric,
   exp) {
      return function () {
         switch (exp.ctor)
         {case "Ap":
            return A2($Basics._op["++"],
              A2(showE,numeric,exp._0),
              A2($Basics._op["++"],
              "(",
              A2($Basics._op["++"],
              A2(showE,numeric,exp._1),
              ")")));
            case "Lam":
            return A2($Basics._op["++"],
              "λ(",
              ...
              " : ",
              A2($Basics._op["++"],
              $Basics.toString(exp._0),
              A2($Basics._op["++"],
              ") { ",
              A2($Basics._op["++"],
              A2(showE,numeric,exp._2),
              " }"))))));
            case "Rec":
            return A2($Basics._op["++"],
              "rec(",
              A2($Basics._op["++"],
              A2(showE,numeric,exp._4),
              A2($Basics._op["++"],
              ") { z -> ",
              A2($Basics._op["++"],
              A2(showE,numeric,exp._0),
              ...
              " -> ",
              A2($Basics._op["++"],
              A2(showE,numeric,exp._3),
              " }"))))))))));
            case "S":
            return numeric ? A2(showNum,
              1,
              exp._0) : A2($Basics._op["++"],
              "S ",
              A2(showE,numeric,exp._0));
            case "Var": return exp._0;
            case "Z":
            return numeric ? "0" : "Z";}
         _U.badCase($moduleName,
   ...
   e) {
      return function () {
         switch (e.ctor)
         {case "S": return A2(showNum,
              n + 1,
              e._0);
            case "Z":
            return $Basics.toString(n);}
         return A2($Basics._op["++"],
         $Basics.toString(n),
         A2($Basics._op["++"],
         " + ",
   ...
   var val = function (e) {
      return function () {
         ...
         {case "Lam": return true;
            case "S": return val(e._0);
            case "Z": return true;}
         return false;
      }();
   };
   var Ap = F2(function (a,b) {
      return {ctor: "Ap"
             ,_0: a
             ,_1: b};
   });
   var Lam = F3(function (a,b,c) {
      return {ctor: "Lam"
             ,_0: a
             ,_1: b
             ,_2: c};
   });
   var Rec = F5(function (a,
   b,
   c,
   d,
   e) {
   ...
   var subst = F3(function (r,
   z,
   exp) {
      return function () {
         switch (exp.ctor)
         {case "Ap": return A2(Ap,
              A3(subst,r,z,exp._0),
              A3(subst,r,z,exp._1));
            case "Lam": return _U.eq(exp._1,
              z) ? A3(Lam,
              exp._0,
              exp._1,
              exp._2) : A3(Lam,
            ...
            case "S": return S(A3(subst,
              r,
              z,
              exp._0));
            case "Var": return _U.eq(exp._0,
              z) ? r : Var(exp._0);
            case "Z": return Z;}
         _U.badCase($moduleName,
